  ...
  return {
    ...
    data: {
      ...
      'menuList': [{
        ...
        'parentName': null,
        'name': '采集站点配置',
        'url': 'modules/sys/spiderconfig.html',
        'perms': null,
        'type': 0,
        'icon': 'bianji',
        'orderNum': 0,
        ...
        'parentName': null,
        'name': '开始采集',
        'url': 'modules/sys/spiderstart.html',
        'perms': null,
        'type': 0,
        'icon': 'daohang',
        'orderNum': 0,
        ...
        'parentName': null,
        'name': '采集结果比对',
        'url': 'modules/sys/resultcomparison.html',
        'perms': null,
        'type': 0,
        'icon': 'sousuo',
        'orderNum': 0,
        ...
        'parentName': null,
        'name': '采集结果转换',
        'url': 'modules/sys/resultconversion.html',
        'perms': null,
        'type': 0,
        'icon': 'mudedi',
        'orderNum': 0,
        ...
        'parentName': null,
        'name': '信息资源',
        'url': 'modules/sys/information.html',
        'perms': null,
        'type': 0,
        'icon': 'pinglun',
        'orderNum': 0,
        ...
        'parentName': null,
        'name': '数据转换',
        'url': 'modules/sys/item-conversion.html',
        'perms': null,
        'type': 0,
        'icon': 'fa fa-cog',
        'orderNum': 0,
